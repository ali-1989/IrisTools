...
import 'package:iris_tools/widgets/path/path_segment_type.dart';
...
class _PathOffset {
  ...
  // TO-DO(dnfield): Use a real hashing function - but this should at least be better than the default.
  @override
...
// TO-DO(dnfield): This can probably be cleaned up a bit.  Some of this was designed in such a way to pack data/optimize for C++
